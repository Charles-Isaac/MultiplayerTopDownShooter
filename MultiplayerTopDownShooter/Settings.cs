...
namespace ClonesEngine
{
    static class Settings
    {
        ...
        private const int m_NumberOfBuilding = 50;//16;

        private const float m_GameStretchX = 16F/11;//2000;
        private const float m_GameStretchY = 1F;//2000;

        private const int m_GameSizeX = (int)(3000* m_GameStretchX);//3000;
        private const int m_GameSizeY = (int)(3000 * m_GameStretchY);//3000;
